...
def create_test_data(app):
    with app.app_context():
        ...
        n1 = Notification(
            ...
            action_url=url_for('review.review_request_page', request_id=42)
        )
        ...
        n2 = Notification(
            ...
            title=Notification.prepare_title(nt_review_request),
            text='New review request',
            action_url=url_for('review.review_request_page', request_id=43)
        )
        ...
        n3 = Notification(
            ...
            title=Notification.prepare_title(nt_review_request),
            text='New review request',
            action_url=url_for('review.review_request_page', request_id=44)
        )
