...
class Config(object):
    ...
    PROFILE_IMAGE_URL =  os.environ.get('RECAPTCHA_PRIVATE_KEY') or '/PROFILE_IMAGE_URL/res/profileImages/'

    # Mail Limit = ML
    # per day
    CONFIRM_REGISTRATION_ML =  os.environ.get('CONFIRM_REGISTRATION_ML') or 5
    INVITE_USER_ML = os.environ.get('INVITE_USER_ML') or 3
    # per month
    CHANGE_MAIL_ML = os.environ.get('CHANGE_MAIL_ML') or 3
