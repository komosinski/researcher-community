...
class SimilarityForClassification:
    ...
    def train_svm(self):
        ...
        print(classification_report(le.transform(test_labels), pred))# , target_names=target_names))
        print("Accuracy", accuracy_score(le.transform(test_labels), pred))
        print("F1", f1_score(le.transform(test_labels), pred))
...
if __name__ == '__main__':
    ...
    sim = SimilarityForClassification('../../data/raw/categories/', measure)
