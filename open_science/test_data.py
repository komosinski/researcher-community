...
def create_test_data(app):
    with app.app_context():
        ...
        pve1_1 = PaperRevision(
            ...
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}1.pdf"),
        ...
        pve2_1 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}2.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve3 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}3.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve4 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}4.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve5 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}5.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve6 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}6.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve7 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}7.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve8 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}8.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve9 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}9.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve10 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}10.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve11 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}11.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve12 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}12.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve13 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}13.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve14 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}14.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        pve15_1 = PaperRevision(
            ...
            abstract="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus in felis metus. Integer commodo "
                        ...
                        "luctus arcu tempus interdum. Mauris in diam eu sapien bibendum auctor laoreet sit amet quam. "
                        "Suspendisse auctor id orci quis placerat.",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}15.pdf"),
            publication_date=dt.datetime(2020, 8, 1, 2, 2, 2, 2),
            confidence_level=2
        )
        ...
        cp1 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}16.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}16.pdf"),
        )
        cp1.rel_author = u1
        db.session.add(cp1)

        cp2 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}17.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}17.pdf"),
        )
        cp2.rel_author = u1
        db.session.add(cp2)

        cp3 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}18.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}18.pdf"),
        )
        cp3.rel_author = u1
        db.session.add(cp3)

        cp4 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}19.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}19.pdf"),
        )
        cp4.rel_author = u1
        db.session.add(cp4)

        cp5 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}20.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}20.pdf"),
        )
        cp5.rel_author = u1
        db.session.add(cp5)

        cp6 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}21.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}21.pdf"),
        )
        cp6.rel_author = u1
        db.session.add(cp6)

        cp7 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}22.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}22.pdf"),
        )
        cp7.rel_author = u1
        db.session.add(cp7)

        cp8 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}23.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}23.pdf"),
        )
        cp8.rel_author = u1
        db.session.add(cp8)

        cp9 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}24.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}24.pdf"),
        )
        cp9.rel_author = u1
        db.session.add(cp9)

        cp10 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}25.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}25.pdf"),
        )
        cp10.rel_author = u1
        db.session.add(cp10)

        cp11 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}26.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}26.pdf"),
        )
        cp11.rel_author = u1
        db.session.add(cp11)

        cp12 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}27.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}27.pdf"),
        )
        cp12.rel_author = u1
        db.session.add(cp12)

        cp13 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}28.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}28.pdf"),
        )
        cp13.rel_author = u1
        db.session.add(cp13)

        cp14 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}29.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}29.pdf"),
        )
        cp14.rel_author = u1
        db.session.add(cp14)

        cp15 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}30.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}30.pdf"),
        )
        cp15.rel_author = u1
        db.session.add(cp15)

        cp16 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}31.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}31.pdf"),
        )
        cp16.rel_author = u1
        db.session.add(cp16)

        cp17 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}32.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}32.pdf"),
        )
        cp17.rel_author = u1
        db.session.add(cp17)

        cp18 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}33.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}33.pdf"),
        )
        cp18.rel_author = u1
        db.session.add(cp18)

        cp19 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}34.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}34.pdf"),
        )
        cp19.rel_author = u1
        db.session.add(cp19)

        cp20 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}35.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}35.pdf"),
        )
        cp20.rel_author = u1
        db.session.add(cp20)

        cp21 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}36.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}36.pdf"),
        )
        cp21.rel_author = u1
        db.session.add(cp21)

        cp22 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}37.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}37.pdf"),
        )
        cp22.rel_author = u1
        db.session.add(cp22)

        cp23 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}38.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}38.pdf"),
        )
        cp23.rel_author = u1
        db.session.add(cp23)

        cp24 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}39.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}39.pdf"),
        )
        cp24.rel_author = u2
        db.session.add(cp24)

        cp25 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}40.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}40.pdf"),
        )
        cp25.rel_author = u2
        db.session.add(cp25)

        cp26 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}41.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}41.pdf"),
        )
        cp26.rel_author = u2
        db.session.add(cp26)

        cp27 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}42.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}42.pdf"),
        )
        cp27.rel_author = u2
        db.session.add(cp27)

        cp28 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}43.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}43.pdf"),
        )
        cp28.rel_author = u2
        db.session.add(cp28)

        cp29 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}44.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}44.pdf"),
        )
        cp29.rel_author = u2
        db.session.add(cp29)

        cp30 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}45.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}45.pdf"),
        )
        cp30.rel_author = u2
        db.session.add(cp30)

        cp31 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}46.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}46.pdf"),
        )
        cp31.rel_author = u2
        db.session.add(cp31)

        cp32 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}47.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}47.pdf"),
        )
        cp32.rel_author = u2
        db.session.add(cp32)

        cp33 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}48.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}48.pdf"),
        )
        cp33.rel_author = u2
        db.session.add(cp33)

        cp34 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}49.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}49.pdf"),
        )
        cp34.rel_author = u2
        db.session.add(cp34)

        cp35 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}50.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}50.pdf"),
        )
        cp35.rel_author = u2
        db.session.add(cp35)

        cp36 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}51.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}51.pdf"),
        )
        cp36.rel_author = u2
        db.session.add(cp36)

        cp37 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}52.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}52.pdf"),
        )
        cp37.rel_author = u2
        db.session.add(cp37)

        cp38 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}53.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}53.pdf"),
        )
        cp38.rel_author = u2
        db.session.add(cp38)

        cp39 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}54.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}54.pdf"),
        )
        cp39.rel_author = u2
        db.session.add(cp39)

        cp40 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}55.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}55.pdf"),
        )
        cp40.rel_author = u2
        db.session.add(cp40)

        cp41 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}56.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}56.pdf"),
        )
        cp41.rel_author = u2
        db.session.add(cp41)

        cp42 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}57.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}57.pdf"),
        )
        cp42.rel_author = u2
        db.session.add(cp42)

        cp43 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}58.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}58.pdf"),
        )
        cp43.rel_author = u2
        db.session.add(cp43)

        cp44 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}59.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}59.pdf"),
        )
        cp44.rel_author = u2
        db.session.add(cp44)

        cp45 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}60.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}60.pdf"),
        )
        cp45.rel_author = u2
        db.session.add(cp45)

        cp46 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}61.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}61.pdf"),
        )
        cp46.rel_author = u2
        db.session.add(cp46)

        cp47 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}62.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}62.pdf"),
        )
        cp47.rel_author = u3
        db.session.add(cp47)

        cp48 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}63.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}63.pdf"),
        )
        cp48.rel_author = u3
        db.session.add(cp48)

        cp49 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}64.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}64.pdf"),
        )
        cp49.rel_author = u3
        db.session.add(cp49)

        cp50 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}65.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}65.pdf"),
        )
        cp50.rel_author = u3
        db.session.add(cp50)

        cp51 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}66.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}66.pdf"),
        )
        cp51.rel_author = u3
        db.session.add(cp51)

        cp52 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}67.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}67.pdf"),
        )
        cp52.rel_author = u3
        db.session.add(cp52)

        cp53 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}68.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}68.pdf"),
        )
        cp53.rel_author = u3
        db.session.add(cp53)

        cp54 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}69.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}69.pdf"),
        )
        cp54.rel_author = u3
        db.session.add(cp54)

        cp55 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}70.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}70.pdf"),
        )
        cp55.rel_author = u3
        db.session.add(cp55)

        cp56 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}71.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}71.pdf"),
        )
        cp56.rel_author = u3
        db.session.add(cp56)

        cp57 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}72.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}72.pdf"),
        )
        cp57.rel_author = u3
        db.session.add(cp57)

        cp58 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}73.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}73.pdf"),
        )
        cp58.rel_author = u3
        db.session.add(cp58)

        cp59 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}74.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}74.pdf"),
        )
        cp59.rel_author = u3
        db.session.add(cp59)

        cp60 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}75.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}75.pdf"),
        )
        cp60.rel_author = u3
        db.session.add(cp60)

        cp61 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}76.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}76.pdf"),
        )
        cp61.rel_author = u3
        db.session.add(cp61)

        cp62 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}77.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}77.pdf"),
        )
        cp62.rel_author = u3
        db.session.add(cp62)

        cp63 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}78.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}78.pdf"),
        )
        cp63.rel_author = u3
        db.session.add(cp63)

        cp64 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}79.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}79.pdf"),
        )
        cp64.rel_author = u3
        db.session.add(cp64)

        cp65 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}80.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}80.pdf"),
        )
        cp65.rel_author = u3
        db.session.add(cp65)

        cp66 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}81.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}81.pdf"),
        )
        cp66.rel_author = u3
        db.session.add(cp66)

        cp67 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}82.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}82.pdf"),
        )
        cp67.rel_author = u3
        db.session.add(cp67)

        cp68 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}83.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}83.pdf"),
        )
        cp68.rel_author = u3
        db.session.add(cp68)

        cp69 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}84.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}84.pdf"),
        )
        cp69.rel_author = u3
        db.session.add(cp69)

        cp70 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}85.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}85.pdf"),
        )
        cp70.rel_author = u4
        db.session.add(cp70)

        cp71 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}86.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}86.pdf"),
        )
        cp71.rel_author = u4
        db.session.add(cp71)

        cp72 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}87.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}87.pdf"),
        )
        cp72.rel_author = u4
        db.session.add(cp72)

        cp73 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}88.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}88.pdf"),
        )
        cp73.rel_author = u4
        db.session.add(cp73)

        cp74 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}89.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}89.pdf"),
        )
        cp74.rel_author = u4
        db.session.add(cp74)

        cp75 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}90.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}90.pdf"),
        )
        cp75.rel_author = u4
        db.session.add(cp75)

        cp76 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}91.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}91.pdf"),
        )
        cp76.rel_author = u4
        db.session.add(cp76)

        cp77 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}92.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}92.pdf"),
        )
        cp77.rel_author = u4
        db.session.add(cp77)

        cp78 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}93.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}93.pdf"),
        )
        cp78.rel_author = u4
        db.session.add(cp78)

        cp79 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}94.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}94.pdf"),
        )
        cp79.rel_author = u4
        db.session.add(cp79)

        cp80 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}95.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}95.pdf"),
        )
        cp80.rel_author = u4
        db.session.add(cp80)

        cp81 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}96.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}96.pdf"),
        )
        cp81.rel_author = u4
        db.session.add(cp81)

        cp82 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}97.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}97.pdf"),
        )
        cp82.rel_author = u4
        db.session.add(cp82)

        cp83 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}98.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}98.pdf"),
        )
        cp83.rel_author = u4
        db.session.add(cp83)

        cp84 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}99.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}99.pdf"),
        )
        cp84.rel_author = u4
        db.session.add(cp84)

        cp85 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}100.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}100.pdf"),
        )
        cp85.rel_author = u4
        db.session.add(cp85)

        cp86 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}101.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}101.pdf"),
        )
        cp86.rel_author = u4
        db.session.add(cp86)

        cp87 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}102.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}102.pdf"),
        )
        cp87.rel_author = u4
        db.session.add(cp87)

        cp88 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}103.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}103.pdf"),
        )
        cp88.rel_author = u4
        db.session.add(cp88)

        cp89 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}104.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}104.pdf"),
        )
        cp89.rel_author = u4
        db.session.add(cp89)

        cp90 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}105.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}105.pdf"),
        )
        cp90.rel_author = u4
        db.session.add(cp90)

        cp91 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}106.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}106.pdf"),
        )
        cp91.rel_author = u4
        db.session.add(cp91)

        cp92 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}107.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}107.pdf"),
        )
        cp92.rel_author = u4
        db.session.add(cp92)

        cp93 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}108.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}108.pdf"),
        )
        cp93.rel_author = u5
        db.session.add(cp93)

        cp94 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}109.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}109.pdf"),
        )
        cp94.rel_author = u5
        db.session.add(cp94)

        cp95 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}110.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}110.pdf"),
        )
        cp95.rel_author = u5
        db.session.add(cp95)

        cp96 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}111.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}111.pdf"),
        )
        cp96.rel_author = u5
        db.session.add(cp96)

        cp97 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}112.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}112.pdf"),
        )
        cp97.rel_author = u5
        db.session.add(cp97)

        cp98 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}113.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}113.pdf"),
        )
        cp98.rel_author = u5
        db.session.add(cp98)

        cp99 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}114.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}114.pdf"),
        )
        cp99.rel_author = u5
        db.session.add(cp99)

        cp100 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}115.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}115.pdf"),
        )
        cp100.rel_author = u5
        db.session.add(cp100)

        cp101 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}116.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}116.pdf"),
        )
        cp101.rel_author = u5
        db.session.add(cp101)

        cp102 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}117.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}117.pdf"),
        )
        cp102.rel_author = u5
        db.session.add(cp102)

        cp103 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}118.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}118.pdf"),
        )
        cp103.rel_author = u5
        db.session.add(cp103)

        cp104 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}119.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}119.pdf"),
        )
        cp104.rel_author = u5
        db.session.add(cp104)

        cp105 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}120.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}120.pdf"),
        )
        cp105.rel_author = u5
        db.session.add(cp105)

        cp106 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}121.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}121.pdf"),
        )
        cp106.rel_author = u5
        db.session.add(cp106)

        cp107 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}122.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}122.pdf"),
        )
        cp107.rel_author = u5
        db.session.add(cp107)

        cp108 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}123.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}123.pdf"),
        )
        cp108.rel_author = u5
        db.session.add(cp108)

        cp109 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}124.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}124.pdf"),
        )
        cp109.rel_author = u5
        db.session.add(cp109)

        cp110 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}125.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}125.pdf"),
        )
        cp110.rel_author = u5
        db.session.add(cp110)

        cp111 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}126.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}126.pdf"),
        )
        cp111.rel_author = u5
        db.session.add(cp111)

        cp112 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}127.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}127.pdf"),
        )
        cp112.rel_author = u5
        db.session.add(cp112)

        cp113 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}128.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}128.pdf"),
        )
        cp113.rel_author = u5
        db.session.add(cp113)

        cp114 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}129.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}129.pdf"),
        )
        cp114.rel_author = u5
        db.session.add(cp114)

        cp115 = CalibrationPaper(
            pdf_url=f"{app.config['TEST_PDFS_URL']}130.pdf",
            preprocessed_text=get_text(f"{app.config['TEST_PDFS_FULL_URL']}130.pdf"),
        )
        cp115.rel_author = u5
