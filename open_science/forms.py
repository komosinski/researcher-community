...
class AdvancedSearchUserForm(FlaskForm):
    first_name = StringField(label='First name', validators=[Length(max=63), Optional()])
    second_name = StringField(label='Second name', validators=[Length(max=63), Optional()])
    affiliation = StringField(label='Affiliation', validators=[Length(max=127), Optional()])
...
class AdvancedSearchTagForm(FlaskForm):
    ...
    description = StringField(label='Description', validators=[Length(max=63), Optional()])
