...
class Badge(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(mc.B_NAME_L), unique=True, nullable=False)
    description = db.Column(db.String(mc.B_DESCRIPTION_L), nullable=False)
    icon_unicode = db.Column(db.String(mc.B_ICON_UNICODE_L))
    condition = db.Column(db.String(mc.B_CONDITION_L), nullable=False)
