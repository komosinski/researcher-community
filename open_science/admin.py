...
class UserView(MyModelView):
    ...
    can_edit = True
    can_delete = False
    column_sortable_list = ['id','registered_on','reputation','confirmed', ('first_name', 'second_name')]
    column_searchable_list = ['id','first_name','second_name','email']
    list_columns = ['id','first_name','second_name','email','privileges_set','registered_on','confirmed','affiliation','orcid','google_scholar','about_me','persona_website','reputation','weight' ]
